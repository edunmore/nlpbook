...
**Nexus:** *Conflict detected. Surface level: Configuration. Deep structure: Values.*
...
**Nexus:** *Inquiry:* What is the positive intent of the opposing behavior?
**Nexus:** *Task:* Validate the intent, then negotiate the method.

...
**Nexus:** *Inquiry:* A problem state focuses on the past/present. A solution state focuses on the future.
**Nexus:** *Task:* Shift the temporal index. Ask a question that presupposes the solution exists.

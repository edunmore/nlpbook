---
id: task-1
title: 'Draft CH001: The Glitch in the System'
status: Writer Done
assignee: []
...
Summary: Kickoff derails; Elara tightens control; Nexus asks one question and assigns a tiny experiment.
Source Material: 
- NLP  01a-Introduction, communication model, learning state.txt
- NLP  01b-peripheral vision, holographic nature of memory, mind-bodyconnection.txt

Instructions:
1. Read source material for concepts/inspiration.
2. Write the chapter following planning/chapter-cards/CH001.md.
...
"That's exactly why we're not cutting over until Week 4," Elara said. "You're right to worry about the edge cases. That's why Ben is running the stability scripts."

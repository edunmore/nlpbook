---
id: task-6
title: 'Draft CH006: The Body’s Vote'
status: Writer Doing
assignee: []
...
Summary: Elara treats sensations as telemetry; catches escalation earlier.
Source Material:
- NLP  06a-metamodelIII, not knowing, de-identification, changing reality strategy.txt
- NLP  06B-Logical Levels, Hierarchy Of Ideas, Miltonmodel, Hierarchy Of Ideas Negatiation Model.txt

Instructions:
1. Read source material for concepts/inspiration.
2. Write the chapter following planning/chapter-cards/CH006.md.
